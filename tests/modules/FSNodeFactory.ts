...
export default function FSNodeFactory(name: string, ext: string, type: "page" | "image"): FileSystemNode {
...
export function EFSNodeFactory(...props: Parameters<typeof FSNodeFactory>): ExtendedFSNode {
